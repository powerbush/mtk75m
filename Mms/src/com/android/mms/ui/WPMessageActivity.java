...
public class WPMessageActivity extends Activity
   ...
   private static void log(String logMsg) {
       ...
       Xlog.d(WP_TAG, "WPMessageActivity: " + logMsg);
   }
   ...
   private boolean isCursorValid() {
       ...
       if (cursor.isClosed() || cursor.isBeforeFirst() || cursor.isAfterLast()) {
           Xlog.e(WP_TAG, "WPMessageActivity: " + "Bad cursor.", new RuntimeException());
           return false;
       }
       return true;
   }
   ...
   public void startActivityForResult(Intent intent, int requestCode)
   {
       if (null != intent && null != intent.getData()
           ...
           try {
               ...
               Xlog.w(WP_TAG, "Failed to startActivityForResult: " + intent);
               Intent i = new Intent().setClassName("com.android.email", "com.android.email.activity.setup.AccountSetupBasics");
               this.startActivity(i);
               finish();
           } catch (Exception e) {
               Xlog.e(WP_TAG, "Failed to startActivityForResult: " + intent);
   ...
   private final void addCallAndContactMenuItems(
       ...
       Xlog.i(WP_TAG, "WPMessageActivity: " + "uris is : " + uris);
   ...
   private final OnCreateContextMenuListener mMsgListMenuCreateListener =
       ...
       public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
           ...
           if (msgItem == null) {
               Xlog.e(WP_TAG, "WPMessageActivity: " + "Cannot load message item for type = " + type
                       + ", msgId = " + msgId);
               return;
           }
   ...
   private void forwardMessage(WPMessageItem msgItem) {
       ...
       Xlog.i(WP_TAG, "WPMessageActivity: " + "forwardMessage msgItem.mBody is : " + msgItem.mBody);
       ...
       public boolean onMenuItemClick(MenuItem item) {
           ...
           switch (item.getItemId()) {
               ...
               case MENU_GOTO_BROWSER:
            	   if(null == msgItem.mURL){
            		   Xlog.i(WP_TAG, "WPMessageActivity: " + "MENU_GOTO_BROWSER msgItem.mURL is null.");
            		   return true;
            	   }
               ...
               case MENU_DELETE_MESSAGE: {
                   ...
                   Xlog.d(WP_TAG, "WPMessageActivity: " + "where:" + where);
   ...
   private static String getWPMessageDetails(Context context, Cursor cursor) {
       ...
       Xlog.i(WP_TAG, "WPMessageActivity: " + "type is : " + type);
       ...
       if(WapPush.TYPE_SI == type){
    	   switch(priority){
    	   case SI_ACTION_NONE:
    		   Xlog.i(WP_TAG, "WPMessageActivity: " + "action error, none");
    		   break;
    	   case SI_ACTION_LOW:
    	   ...
    	   case SI_ACTION_DELETE:
    		   Xlog.i(WP_TAG, "WPMessageActivity: " + "action error, delete");
    		   break;
    	   default:
    		   Xlog.i(WP_TAG, "WPMessageActivity: " + "getWPMessageDetails si priority error.");
    	   }
    	   ...
    	   case SL_ACTION_CACHE:
    		   ...
    		   break;
    	   default:
    		   Xlog.i(WP_TAG, "WPMessageActivity: " + "getWPMessageDetails sl priority error.");
    	   }
       }else{
    	   Xlog.i(WP_TAG, "WPMessageActivity: " + "getWPMessageDetails type error.");
       }
...
//       }       
   ...
   protected void onCreate(Bundle savedInstanceState) {
       ...
       Xlog.i(WP_TAG, "WPMessageActivity: " + "Enter onCreate function.");
...
protected void onAddContactButtonClickInt(final String number ,final boolean startActivityForResult) {
   ...
   protected void onRestart() {
	   Xlog.i(WP_TAG, "WPMessageActivity: " + "Enter onRestart function.");
       super.onRestart();
...
//       } 
   ...
   protected void onStop() {
       ...
       Xlog.i(WP_TAG, "WPMessageActivity: " + "onStop stopExpiredCheck.");
   ...
   public void onConfigurationChanged(Configuration newConfig) {
       ...
       if (LOCAL_LOGV) {
           Xlog.v(WP_TAG, "WPMessageActivity: " + "onConfigurationChanged: " + newConfig);
       }
   }
           ...
           case KeyEvent.KEYCODE_DEL:
               if ((mMsgListAdapter != null) && mMsgListView.isFocused()) {
                   ...
                   try {
                       ...
                       Xlog.e(WP_TAG, "WPMessageActivity: " + "Unexpected ClassCastException.", e);
   ...
   public void onUserInteraction() {
	   Xlog.w(WP_TAG,"onUserInteraction!");
   ...
   public void onWindowFocusChanged(boolean hasFocus) {
       if (hasFocus) {
    	   Xlog.w(WP_TAG,"onWindowFocusChanged!");
    	   checkPendingNotification();
       }
   }
