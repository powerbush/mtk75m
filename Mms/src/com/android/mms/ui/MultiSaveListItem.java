...
class MultiSaveHeaderItem extends RelativeLayout {  
    private TextView mTextView;
    private CheckBox mCheckBox;

    public MultiSaveHeaderItem(Context context) {
        super(context);
    }
    
    public MultiSaveHeaderItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
