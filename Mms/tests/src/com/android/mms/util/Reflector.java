...
public class Reflector {
    ...
    public static class Parameter {
         ...
         * @param param the object, may be null.
         */
        public Parameter(Class<?> type, Object param) {
            this.type = type;
            this.param = param;
        }
    }
     ...
     * @throws Throwable if error occars.
     * @see Class#getConstructor(Class...)
     * @see Constructor#newInstance(Object...)
     */
    public static <T> T newInstance(Class<T> cls, Parameter... params) throws Throwable {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Object invoke(Object obj, String name, Parameter... params) throws Throwable {
        Class<?> cls = obj instanceof Class ? (Class<?>) obj : obj.getClass() ;
        if (params == null || params.length == 0) {
            try {
                while (cls != null) {
