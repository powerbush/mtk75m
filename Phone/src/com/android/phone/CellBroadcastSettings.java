...
/* Fion add end */
        ...
        for (int i = 0; i < number; i++) {
            ...
            for (int j = ChannelObjectBeginIndex; j <= ChannelObjectEndIndex; j++) {
                ...
                if (channel!= null)
                     ...
                     Xlog.i(LOG_TAG,"updateChannelEnableState(): object is null");
            }
        }
    }
    ...
    private void dumpConfigInfo(SmsBroadcastConfigInfo info)
    {
        ...
        Xlog.d(LOG_TAG, "FromServiceId " + info.getFromServiceId() + "  ToServiceId " +info.getToServiceId());
        Xlog.d(LOG_TAG, "FromCodeId " + info.getFromCodeScheme() + "  ToCodeId " +info.getToCodeScheme());
